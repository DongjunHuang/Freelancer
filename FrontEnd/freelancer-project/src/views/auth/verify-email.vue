...
<template>
  <div class="min-h-screen flex justify-center items-start bg-gray-50 px-4 pt-20">
    <div
      class="w-full max-w-md bg-white rounded-2xl shadow p-8 text-center flex flex-col items-center space-y-3"
    >
      <!-- Loading -->
      <template v-if="state === 'loading'">
        <div
          class="mx-auto h-10 w-10 animate-spin border-2 border-blue-600 border-t-transparent rounded-full"
        ></div>
