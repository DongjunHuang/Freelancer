...
<template>
  <section class="mb-6 rounded-2xl bg-white px-6 py-5 shadow-sm border border-slate-100">
    ...
    <div v-if="usingExisting" class="mt-2">
      <label class="mb-1 block text-[11px] font-medium text-slate-500"> Existing datasets </label>
    ...
    <div v-else class="mt-2">
      <label class="mb-1 block text-[11px] font-medium text-slate-500"> New dataset name </label>
      <input
