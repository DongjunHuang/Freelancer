...
public interface DatasetRecordRepo extends MongoRepository<DatasetRecord, String>, DatasetRecordRepoCustom {
    ...
    @Query("""
            ...
            """)
    public List<DatasetRecord> findByDatasetIdAndVersionAndUploadDateBetween(String datasetId, Integer version,
    ...
    @Query("""
            ...
            """)
    public List<DatasetRecord> findByDatasetIdAndVersionAndUploadDateBetweenAndSymbols(String datasetId,
