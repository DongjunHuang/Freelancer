...
public class UploadService {
    ...
    public long appendRecords(MultipartFile file, DataProps dataRecordProps) {
        ...
        try {
            ...
            try (var parser = new CSVParser(
                ...
                List<Map<String, String>> inferRows = getMaps(parser, headers);
            ...
            if (dataset != null) {
                ...
                dataset.setLastErrorMessage(ibex.getMessage());
                metadataRepo.save(dataset);
            }
    ...
    private static List<Map<String, String>> getMaps(CSVParser parser, List<String> headers) {
